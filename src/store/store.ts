...
import { PostDataRequestAction, PostDataRequestSuccessAction, PostDataRequestErrorAction, POST_DATA_REQUEST, POST_DATA_REQUEST_ERROR, POST_DATA_REQUEST_SUCCESS } from "./postData/action";
import { postDataReduser, PostDataState } from "./postData/reducer";
import { PostListRequestAction, PostListRequestErrorAction, PostListRequestSuccessAction, POST_LIST_REQUEST, POST_LIST_REQUEST_ERROR, POST_LIST_REQUEST_SUCCESS } from "./postList/action";
